...
if page == 'Homepage':
    ...
    st.write("""Through this application, you may insert your favorite College D1 Football Team in the searchbox below.
                 Once your favorite team has been entered, navigate over to the dropdown section
                 to review your team's overall win/loss/tie record, visualizations, and your team's overall record with matchup information against the team of your choose.
                 """)
